...
import EditFoodModal from "../../components/health/EditFoodModal";
...
export default function FoodList() {
  ...
  return (
    <>
      <PageMeta
        title={`${t("foods.title")} | Health Care Admin`}
          ...
          {filteredFoods.map((food) => (
            ...
            >
              ...
              <div className="space-y-3">
                ...
                {food.categoryResponse && (
                  <div className="text-xs text-gray-500">
                    Danh mục: {food.categoryResponse.categoryName}
                  </div>
                )}
                ...
                <div className="flex justify-between items-center pt-2">
                  <span
                    className={`px-2 py-1 text-xs font-medium rounded-full ${
                      food.difficultyLevel === "EASY"
                        ? "bg-green-100 text-green-800"
                        : food.difficultyLevel === "MEDIUM"
                        ? "bg-yellow-100 text-yellow-800"
                        : "bg-red-100 text-red-800"
                    }`}
                  >
                    {getDifficultyLabel(food.difficultyLevel)}
                  </span>
