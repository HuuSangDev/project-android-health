...
export default function UserList() {
  ...
  const getBMICategory = (bmi: string) => {
    ...
    if (bmiNum < 25)
      return { category: "Bình thường", color: "text-green-600" };
  ...
  const filteredUsers = users.filter((user) => {
    ...
    const matchesGoal =
      selectedGoal === "ALL" ||
      user.userProfileResponse?.healthGoal === selectedGoal;
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          >
            ...
            <option value="WEIGHT_GAIN">{t("users.weightGain")}</option>
            <option value="MAINTAIN">{t("users.maintainWeight")}</option>
          </select>
        </div>
                        ...
                        <span
                          className={`px-2 py-1 text-xs font-medium rounded-full ${
                            profile?.healthGoal === "WEIGHT_LOSS"
                              ...
                              : profile?.healthGoal === "WEIGHT_GAIN"
                              ? "bg-purple-100 text-purple-800"
                              : profile?.healthGoal === "MAINTAIN"
